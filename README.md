# Berikut adalah hasil Layout dengan menggunakan Framework Boostrap.

### Berikut adalah SC-nya..!!
```html
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
    <div class="container-md shadow-lg p-3 mb-5 bg-body rounded">
        <div class="card-body">
          ...
          <nav class="navbar navbar-dark" style="background-color: #1f5faa;">
            <ul class="nav">
                <li class="nav-item">
          ...
          <div class="row">
              <div class="col-8-md">
                <div class="card mb-3" style="max-width: 540px; border: 0px; margin-top: -100px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="Kosong.jpg" class="img-fluid rounded-start" alt="..." style="border: 1px solid #e4e4e5;">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
          ...
          <div class="card-footer" style="background-color: #1d1d1d;">
              <p class="text-light pt-2">&copy; 2021 - Universitas Pelita Bangsa</p>
          </div>
      </div>
...
### Hasilnya..!!
 ![img](lab6_css_framework/img6.1.JPG)